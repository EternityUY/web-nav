...
export default function LinkCard({ link }: LinkCardProps) {
  ...
  return (
    ...
    >
      <Vaso
        {...preset}
        className="relative flex items-center gap-3 rounded-xl dark:bg-white/[0.06] dark:border-white/[0.08] dark:hover:bg-white/[0.12] dark:hover:border-white/[0.15] glass-card px-4 py-3 transition-all duration-200 hover:bg-white/80 hover:border-gray-300"
      >
        {/* Pin badge */}
        {link.pinned && (
